...
const BlogList = () => {
    return (
     ...
     <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
            <div>
                <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl ">Recent Blogs</h2>
	...
	<div className="container grid grid-cols-12 mx-auto">
        ...
        style={{backgroundImage: 'url("https://source.unsplash.com/random/640x480")'}}>
