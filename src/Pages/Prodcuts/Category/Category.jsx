...
const Category = () => {
    ...
    return (
        <section>
            ...
            <div className="grid lg:grid-cols-3 grid-cols-2 px-6 gap-4">
 
 {
    ...
    <p>
    Post Created On: {item.createdAt.slice(0,10)} at : {item.createdAt.slice(12,19)}
    </p>
     </div>
     <div className="flex font-bold justify-between items-start ">
     <p className=' pr-2' >
    ...
    SellIng Price : ${item.sellPrice}
     ...
     <div className="flex font-bold justify-between items-start ">
     <p className=' pr-2' >
       Used Years : {item.usePeriodOfTime} Years
    </p>
    <p className=' pl-2' >
    SellIng Price : ${item.sellPrice}
    </p>
